...
var Search = (function () {
    ...
    function search(event) {
        ...
        var form = document.querySelector('[data-search-form]');
        var searchResults = document.querySelector('[data-search-results]');
        var searchResultEntries = document.querySelector('[data-search-results] .search-results__entries');
        ...
        results.forEach(function (result, index) {
            ...
            entry.innerHTML += '<a href="' + document.baseURI + result.url + '">' + result.fqsen + '</a>';
    ...
    function init() {
        ...
        var closeButton = document.querySelector('.search-results__close');
